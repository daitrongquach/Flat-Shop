...
<head>
	...
	<link rel="shortcut icon" href="<?= base_url()?>application/views/includes/admin/icon.png" />
		...
		<header>
			...
			<div class="grid_16">
				<ul class="sf-menu" id="navigationTop">
                    <?php if($name_session['ma_quyen'] == 1){?><li><a href="<?= base_url();?>admin/home/inventory">Báo cáo & thống kê</a></li><?php }?>
